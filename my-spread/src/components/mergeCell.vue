<template>
  <div  >
      <!-- <gc-spread-sheets :hostClass='hostClass'>
        <gc-worksheet :dataSource="dataTable" :autoGenerateColumns = 'autoGenerateColumns' style="border: 2px solid black;"> -->
          <!-- <gc-column :width="width"  :dataField="'price'" :visible = 'visible'  :formatter = 'formatter' :resizable = 'resizable'
          ></gc-column> -->
          <div class="sample-tutorial" >  <!--合并单元格   -->
          ...
          <div class="options-container">
            <div class="demo-options">
                ...
                <div class="option-row">
                    <input type="button" value="合并单元格" title="Merge cells in selected range to one cell" id="btnMerge"  @click="addCell"/>
                    <input type="button" value="拆分单元格" title="Unmerge cells in selected range back to all in a single cell" id="btnUnMerge" @click="splitCell"/>
                </div>
            </div>
            <div class="demo-options" style="padding-top: 16px">
                ...
                <div class="option-row">
                    <label>
                        <input type="checkbox" id="allowDragMerge" @click="dragMerger">
                        允许拖动合并
                    </label>
                </div>
            </div>
